  ...
  FROM (
         SELECT vft.table_schema,
                ...
                COALESCE(ca.field_view_type, 'simple'::character varying) AS
                  field_view_type
         FROM icredit.dic_table_for_v_contact_tech_sp dtf_ct,icredit.v_field_type vft
              ...
              LEFT JOIN icredit.contacts_access ca ON vft.column_name::bpchar =
                ...
                ::bpchar
         WHERE /*vft.table_name::text = 'contacts'::text OR
               vft.table_name::text = 'contacts_pwd'::text*/
               vft.table_name::text = dtf_ct.name
       ) f_sel
