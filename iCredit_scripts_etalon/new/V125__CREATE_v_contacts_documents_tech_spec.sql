--
-- Definition for view v_contacts_documents_tech_spec (OID = 60056) : 
--
CREATE VIEW icredit.v_contacts_documents_tech_spec
AS
...
FROM (((((
   ...
   LEFT JOIN icredit.contacts_access ca ON ((((vft.column_name)::bpchar =
    ...
    WHERE ((vft.table_name)::text = 'contacts_documents'::text)
    ) f_sel
