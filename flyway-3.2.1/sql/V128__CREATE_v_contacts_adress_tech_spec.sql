--
-- Definition for view v_contacts_adress_tech_spec (OID = 60051) : 
--
...
FROM (((((
   ...
   LEFT JOIN icredit.contacts_access ca ON ((((vft.column_name)::bpchar =
    ...
    WHERE ((vft.table_name)::text = 'contacts_adress'::text)
    ) f_sel
   ...
   LEFT JOIN (
    SELECT DISTINCT icredit.v_dictionary_with_reffieldname.dic_schema,
    icredit.v_dictionary_with_reffieldname.dic_name,
    icredit.v_dictionary_with_reffieldname.dic_column_name
