...
AS
 ...
 UNION
        ...
        select 'icredit' as table_schema,
         	   'v_dic_name_contacts_block' as table_name,
               NULL AS column_name,
         		cba.id_role,
...
UNION
        ...
        select 'icredit' as table_schema,
         	   'v_dic_contacts_page_number' as table_name,
               NULL AS column_name,
         		cba.id_role,
         vncb.name AS caption_name,
         vncb.localisation,
        ...
        where cba.page_number = vncb.value
  ORDER BY
           14,
           15,
           1,
